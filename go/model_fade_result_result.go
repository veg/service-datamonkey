...
type FadeResultResult struct {
	...
	Fits map[string]FadeResultResultAllOfFitsValue `json:"fits,omitempty"`

	MLE FadeResultResultAllOfMle `json:"MLE,omitempty"`

	SiteAnnotations FadeResultResultAllOfSiteAnnotations `json:"site annotations,omitempty"`
}

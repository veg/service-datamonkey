...
type FelResultResult struct {
	...
	Fits map[string]FelResultResultAllOfFitsValue `json:"fits,omitempty"`

	BranchAttributes FelResultResultAllOfBranchAttributes `json:"branch attributes,omitempty"`

	MLE FelResultResultAllOfMle `json:"MLE,omitempty"`
}

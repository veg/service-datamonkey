...
type RelaxResultResultAllOfFitsGeneralDescriptive struct {
	...
	RateDistributions RelaxResultResultAllOfFitsGeneralDescriptiveRateDistributions `json:"Rate Distributions,omitempty"`
